...
const ISLANDS: Array<{
...
}> = [
  {
    id: 'story',
    title: '故事王国',
    subtitle: 'Bunny 带你读绘本',
    to: '/story',
    theme: 'butter',
    scene: '/assets/art/l0/backgrounds/bg-forest-light.jpg',
    icon: '读',
  },
  {
    id: 'characters',
    ...
    to: '/characters',
    theme: 'mint',
    scene: '/assets/art/l0/backgrounds/bg-meadow.jpg',
    icon: '字',
  },
  {
    id: 'game',
    ...
    to: '/game',
    theme: 'sky',
    scene: '/assets/art/l0/backgrounds/bg-pond.jpg',
    icon: '玩',
  },
  {
    id: 'house',
    ...
    to: '/badges',
    theme: 'pink',
    scene: '/assets/art/l0/backgrounds/bg-sky-day.jpg',
    icon: '藏',
  },
];
...
export function HomePage() {
  ...
  const learnedByIsland = useMemo(() => {
    ...
    for (const character of characters) {
      ...
      if (!state) continue;
      counts[character.island] = (counts[character.island] ?? 0) + 1;
    }
    return counts;
        ...
        right={(
          <div className="home-progress">
            ...
            <div className="home-progress__track">
              <div className="home-progress__fill" style={{ width: `${progressPercent}%` }} />
            </div>
          </div>
        )}
      />
      ...
      <main className="home-page__main">
        <section className="home-hero" aria-label="Bunny 欢迎区">
          ...
          <div className="home-hero__bunny">
            <Bunny pose="cheering" size={320} showBackpack />
          </div>

          <div className="home-hero__stats">
            <div className="home-stat">
              <span className="home-stat__value">{profile.badges.length}</span>
              <span className="home-stat__label">我的勋章</span>
            </div>
            <div className="home-stat">
              <span className="home-stat__value">{profile.streak ?? 0}</span>
              <span className="home-stat__label">连续学习</span>
            </div>
            <div className="home-stat">
              <span className="home-stat__value">12</span>
              <span className="home-stat__label">今日分钟</span>
            </div>
          </div>
        </section>
        ...
        <section className="home-islands" aria-label="学习入口">
          <div className="home-islands__heading">
            ...
            <button className="home-islands__more" type="button" onClick={() => navigate('/daily')}>
              今日学习计划 →
            </button>
          </div>
          ...
          <div className="home-islands__grid">
            {ISLANDS.map((island) => (
              <button
                key={island.id}
                type="button"
                className={`home-island home-island--${island.theme}`}
                onClick={() => navigate(island.to)}
              >
                ...
                <div className="home-island__content">
                  ...
                  <div>
                    <div className="home-island__title">{island.title}</div>
                    <div className="home-island__subtitle">{island.subtitle}</div>
                  </div>
                </div>
